...
func pullCategoryVideos(category:envClass,categoryId : String){
 ...
 //let playlistID = "PLFs4vir_WsTwEd-nJgVJCZPNL3HALHHpF"//in a nutshell
  ...
  // let urlString = "https://www.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=in&key=\(Api_Key)"
    //10 category is for music
let urlString = "https://www.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=\(user.country)&videoCategoryId=\(categoryId)&key=\(Api_Key)"
               ...
               //    DispatchQueue.main.asyncAfter(deadline: .now() + .milliseconds(500), execute: {
                ...
                //    channelImage.downloadImage(urlString: channelThumbnailUrl)}})
                        ...
                        //A Single Video is loaded
                            getChannelDetails_CategoryVideos(channelID: channelID) { (infoChannel) in
                       ...
                       //     print("wwww",channelInfo["channelPlaylistID"])
                        ...
                        if(vid != nil){
                            category.currentVideos_1.append(vid!)
                           vid = nil
                                }}
...
func getChannelDetails_CategoryVideos(channelID:String,completion:@escaping (_ infoChannel :[String:Any])->()){
